...
const confirmationScore = document.querySelector('.js-notactive');
const reset = document.querySelector('.reset-score');
reset.addEventListener('click',()=>
{
   

    confirmationScore.classList.add('js-active');
    document.querySelector('.js-yes').addEventListener('click',()=>
    {
        ...
        updateScoreElement();
        confirmationScore.classList.remove('js-active');
